...
A working demonstration of [Pain S.03: I can't roll back a bad model without downtime](../../../pains/serving/S03-cant-roll-back.md). Both scenarios use the same bad image update — the only difference is the rollout strategy and the presence of a readiness probe.
...
- [`before/README.md`](before/README.md) — includes the one-time setup plus the false success / broken traffic scenario
- [`after/README.md`](after/README.md) — reuses that setup and shows the stalled rollout / clean rollback scenario

---

[← Back to Pain S.03](../../../pains/serving/S03-cant-roll-back.md) · [Landscape](../../../README.md) · [Examples index](../../README.md)
