...
A working demonstration of [Pain S.02: My server image is coupled to its config and secrets](../../../pains/serving/S02-server-image-coupling.md).
...
[← Back to Pain S.02](../../../pains/serving/S02-server-image-coupling.md) · [Examples index](../../README.md)
