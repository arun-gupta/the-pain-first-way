# Pain 5 example: the same model server, two approaches to weight loading

A working demonstration of [Pain 5: Cold start for my 70B model takes 4 minutes](../../pains/05-cold-start.md). Same inference server code, two deployment styles. The init container pattern is the only thing that changes. And that changes everything about portability.
