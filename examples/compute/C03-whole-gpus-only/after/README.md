...
This is the same situation as MIG configuration in [Pain O.01's after example](../../../operations/O01-gpu-underutilized/after/README.md): the manifests are the artefact; a simulated cluster cannot exercise them.
