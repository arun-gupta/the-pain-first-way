...
A working demonstration of [Pain C.02: Can't get a GPU when I need one](../../../pains/compute/C02-cant-get-a-gpu.md). Same training job, two submission styles. The Kubernetes manifests are the only thing that changes.
...
[← Back to Pain C.02](../../../pains/compute/C02-cant-get-a-gpu.md) · [Landscape](../../../README.md) · [Examples index](../../README.md)
