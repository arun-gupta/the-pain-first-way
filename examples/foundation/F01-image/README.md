...
A working demonstration of [Pain F.01: Model works locally, breaks in prod](../../../pains/foundation/F01-model-works-locally.md). Same Python code, two deployment styles. The Dockerfile is the only thing that changes. And it changes everything.
...
[← Back to Pain F.01](../../../pains/foundation/F01-model-works-locally.md) · [Landscape](../../../README.md) · [Examples index](../../README.md)
