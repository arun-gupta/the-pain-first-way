# Pain A.05: My agent looped overnight and burned the budget
...
- **Workflow guardrails**: max steps, max depth, deadlines, and budgets enforced by the durable workflow engine, which builds on [Pain A.01](A01-durable-agents.md).
...
[← Pain A.04: Agent egress control](A04-agent-egress.md) · [Landscape](../../README.md)
