# Pain 24: My agent died halfway through a user task
...
This is related to [Pain 2](02-gpu-job-crashed.md), but the state is not only a training checkpoint. It is a sequence of tool calls and side effects that must remain coherent for the user.
...
[← Pain 23: Reproduce shipped model](23-model-reproducibility.md) · [Landscape](../README.md) · [Pain 25: Tenant isolation →](25-tenant-isolation.md)
