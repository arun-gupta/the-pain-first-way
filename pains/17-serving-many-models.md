# Pain 17: I have 200 fine-tunes and a GPU each would bankrupt me
...
- **Adapter-aware routing**: requests must reach a replica that already has the right model or adapter loaded, which ties directly to [Pain 16](16-inference-routing.md).
...
[← Pain 16: Inference routing](16-inference-routing.md) · [Landscape](../README.md) · [Pain 18: Weight-download stampede →](18-weight-stampede.md)
