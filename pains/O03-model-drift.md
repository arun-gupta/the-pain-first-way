# Pain O.03: I don't know if my model is drifting in production
...
This complements [Pain O.02](O02-latency-spiked.md). Pain O.02 asks why the service is slow. This pain asks whether the model's behavior is still inside the envelope you intended.
...
[← Pain O.02: Latency spiked](O02-latency-spiked.md) · [Landscape](../README.md) · [Pain O.04: Costs out of control →](O04-costs-out-of-control.md)
