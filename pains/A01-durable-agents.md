...
This is related to [Pain C.01](C01-gpu-job-crashed.md), but the state is not only a training checkpoint. It is a sequence of tool calls and side effects that must remain coherent for the user.
...
[← Pain R.03: Audit evidence](R03-audit-evidence.md) · [Landscape](../README.md) · [Pain A.02: Sandboxed code exec →](A02-agent-sandbox.md)
