...
This is the execution-isolation companion to [Pain F.02](F02-model-supply-chain.md). Pain F.02 is "the model you load is untrusted." This pain is "the code the model writes is untrusted."
