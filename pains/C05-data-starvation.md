...
This is distinct from [Pain S.07](S07-weight-stampede.md), the one-time weight-download stampede when serving replicas start. This is the continuous, every-epoch read path of training. Same lesson, fetch once and keep it close, different workload.
...
[← Pain C.04: Multi-node falling over](C04-multi-node-training.md) · [Landscape](../README.md) · [Pain S.01: Cold start →](S01-cold-start.md)
