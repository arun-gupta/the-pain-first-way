...
This pairs with [Pain G.03](../governance/G03-deploy-guardrails.md). Pain G.03 enforces and approves at deploy time; this pain keeps the continuous record that proves it held over the period. It is distinct from [Pain O.03](../operations/O03-model-drift.md), which watches model behavior, and [Pain G.02](../governance/G02-model-reproducibility.md), which reconstructs what shipped. This is the audit trail of cluster actions for an external reviewer.
...
[← Pain R.02: Tenant isolation](R02-tenant-isolation.md) · [Landscape](../../README.md) · [Pain A.01: Durable agents →](../agents/A01-durable-agents.md)
