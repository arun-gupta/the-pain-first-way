# Pain R.02: One customer's workload can starve or leak into another
...
This is different from [Pain R.01](R01-data-residency.md). Residency says where data may live. Tenant isolation says who can share what, and under which enforced boundaries, even inside one region.
...
[← Pain R.01: Data residency](R01-data-residency.md) · [Landscape](../../README.md) · [Pain R.03: Audit evidence →](R03-audit-evidence.md)
