...
- **What changes underneath**: the backing scheduler is Kubernetes. GPUs are managed by device plugins or [DRA](../compute/C03-whole-gpus-only.md). Capacity grows with HPA and Karpenter instead of static node pools.
...
[← Pain H.01: SLURM rewrite](H01-slurm-migration.md) · [Landscape](../../README.md) · [Pain C.01: GPU job crashed →](../compute/C01-gpu-job-crashed.md)
