# Pain S.04: My model passed health checks but failed quality
...
This extends [Pain S.03](S03-cant-roll-back.md). Pain S.03 makes rollback fast and safe. This pain decides whether the rollout should advance in the first place.
...
[← Pain S.03: Can't roll back](S03-cant-roll-back.md) · [Landscape](../../README.md) · [Pain S.05: Inference routing →](S05-inference-routing.md)
