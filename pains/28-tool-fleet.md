# Pain 28: My agent calls a dozen tool servers and any one of them breaks the run
...
- **Rate limiting and quotas**: protect both the tools and the agent from runaway call volume, which is [Pain 30](30-runaway-agents.md).
...
[← Pain 27: Sandboxed code execution](27-agent-sandbox.md) · [Landscape](../README.md) · [Pain 29: Agent egress control →](29-agent-egress.md)
