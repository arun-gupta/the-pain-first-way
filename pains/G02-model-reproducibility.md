...
This connects [Pain F.01](F01-model-works-locally.md), [Pain G.01](G01-prompt-version.md), and [Pain F.02](F02-model-supply-chain.md). Those cover runtime reproducibility, prompt/config history, and artifact trust. This pain ties them into one answerable release record.
